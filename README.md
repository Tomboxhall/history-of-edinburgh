...
| Test | Purpose                                                                                    | How to test                                                                                                                                                                                                                          | What's expected to happen                                                                                                              | Result                                                                                                                                         | Comments |
|------|--------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------|----------|
| 1    | Make sure that Menu links direct user  to correct pages                                    | Cycle between;  Home - History - Contact - (Contact link on Home)                                                                                                                                                                    | When the user clicks on the link they should be directed to the expected page                                                          | When tested, all links took the user to the intended pages                                                                                     |          |
| 2    | Make sure that external links, e.g. Facebook,  go to correct destination, and in a new tab | In the footer; Click on each of the icons                                                                                                                                                                                            | The user should be directed to the facebook, twitter, github and youtube                                                               | When tested, all links took the user to the intended external sites. (Opens in a new tab)                                                      |          |
| 3    | Make sure the NavBar is sticky (to the top)                                                | Open the website, and scroll all the way to the bottom, and back up again                                                                                                                                                            | The NavBar should remain stuck to the top of the webpage, at any position during the scrolling                                         | The NavBar remained stuck to the top of the webpage                                                                                            |          |
| 4    | Does the NavBar visual effects work as intended?                                           | Open the website and Hover the cursor over the Menu links                                                                                                                                                                            | The effect is a scrolling underline from left to right, and should appear when cursor is hovered over, and exit when cursor is removed | The hover effect works as intended. Entering from the left and exiting to the right. It also dissapears when cursor is removed                 |          |
| 5    | Test the responsiveness of the website, across all  screen sizes                           | Open the website, and drag the window from desktop in to mobile sized screen, and out again to desktop                                                                                                                               | The layout of the webpage should change when breakpoints are activated. Maintaining the layout design                                  | When tested the layout remained as intended. Content and images resized and repositioned depending on the screen size (breakpoints)            |          |
| 6    | Make sure the form has correct prompts,  e.g. 'Missing input field'                        | Open the website, navigate to the contact page. Click on the text input, if filled out before a prompt will appear to use previous details, if submitted without content a warning 'Please fill in this field' warning will flash up | If the form is submitted without any content in the specified fields, a warning prompt will appear.                                    | When tested, the prompts appeared when no there was no text input. And when re-visited user was prompted to select previously used information |          |
| 7    | Does the 'Hover effect' on the submit button  work correctly?                              | Hover the cursor over the 'Submit' button on the form                                                                                                                                                                                | The 'Submit Button' should flash a light coral colour, adding a visual prompt                                                          | When tested the 'Submit' button does flash a different colour                                                                                  |          |
| 8    | Make sure the 'Hover:Grow' effect works as  intended on images and links                   | Open the website, and with the cursor hover over the images in 'Historical attractions' section, and links in the footer. On the 'History' page,  hover the cursor over the images alongside the text                                | The images should grow when hovered over, the links in the footer should also grow                                                     | When tested, all images and links with the 'Hover:Grow' effect grow as intended                                                                |          |
| 9    | Make sure the 'Hover:Grow' effect works on  content sections as intended                   | Open the website, and with the cursor hover over the content in the 'Introduction' section.                                                                                                                                          | The content should grow when hovered over                                                                                              | When tested, the content grows as intended when hovered over                                                                                   |          |
